...
s2_address_index = (
    ...
    .groupby("normalized_address")["entity_id"]
    .apply(list)
    .to_dict()
)
...
# ============================================================
# 7. GENERATE UNION CANDIDATES
# ============================================================

print("\nGenerating B0 + B2 union candidates...")
...
for _, row in source1.iterrows():
    ...
    # --------------------------------------------------------
    # B0 — Exact normalized name candidates
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # B2 — Exact normalized address candidates
    # --------------------------------------------------------
    ...
    candidates = name_candidates | address_candidates
...
print("Union candidate generation complete.")

# ============================================================
# 8. UNION BLOCKING STATISTICS
# ============================================================

print("\n" + "=" * 60)
print("B0 + B2 UNION BLOCKING RESULTS")
print("=" * 60)
...
for _, row in ground_truth.iterrows():
    ...
    # Which true matches did we recover?
